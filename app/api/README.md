...
Important: labels are census-informed proxy labels, not official Ubudehe categories.
...
- `GET /sectors` - paginated sector rankings with filters.
...
- `GET /summary` - KPI totals and caveats.
